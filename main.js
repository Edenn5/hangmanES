// GLOBAL VARIABLE (accesible by all functions)
//--------------------------------------------------------------------------------
...
// Holds a mix of blank and solved letters (ex:tit_nic)
...
// Note: The startGame() function is not being run here. It is just being 
//       made for future use.
function startGame(){
    ...
    // We cound the number of letters in the word
